-- ============================================================================
-- SMART CITY IOT DATABASE SCHEMA - PRODUCTION READY v2.0
-- Date: May 2, 2026
-- Description: Complete redesign with spatial clustering, geolocation,
--              and enhanced alert system
-- ============================================================================
...
-- ============================================================================
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE INCIDENT_ALERTS CASCADE CONSTRAINTS';
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE SENSOR_HEALTH_LOGS CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE SENSOR_CAPABILITIES CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE SENSOR_CLUSTERS CASCADE CONSTRAINTS';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
-- ============================================================================
-- TABLE: LOCATIONS
-- Hierarchical location structure (City > District > Ward)
-- ============================================================================
...
-- Normalized sensor capabilities (replaces JSON)
-- ============================================================================
...
-- ============================================================================
-- TABLE: ALERTS
-- Enhanced alert system with predictive and anomaly detection
-- ============================================================================
CREATE TABLE ALERTS (
...
CREATE INDEX idx_alerts_status   ON ALERTS(Status, CreatedAt);
CREATE INDEX idx_alerts_type     ON ALERTS(AlertType);

-- Auto-sync LocationID from sensor or cluster
...
CREATE INDEX idx_incidents_status ON INCIDENTS(Status, CreatedAt);
...
-- Pre-aggregated telemetry data for performance
-- ============================================================================
...
CREATE INDEX idx_summary_granularity ON TELEMETRY_SUMMARY(Granularity, TimeBucket);
...
-- Recursive hierarchical query for location tree traversal
-- ============================================================================
